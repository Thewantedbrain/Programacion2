...
class Empleado(ABC):  # Super Clase o Clase Base
    ...
    def DeterminarSalario(self): #getter
        print("El empleado ",self.nombre, self.apellido, "de cedula de identidad: ", self.cedulaDeIdentidad, "recibe un salario: ",self.__salario)
